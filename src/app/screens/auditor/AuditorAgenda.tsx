...
export function AuditorAgenda() {
  ...
  async function marcarHecho(id: string) {
    try {
      ...
      console.error('[AuditorAgenda] marcarHecho', e)
    ...
    <div className="flex flex-col min-h-screen bg-background pb-10">
      <header className="sticky top-0 z-10 bg-card border-b border-border flex items-center gap-3 px-4 py-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>Visitas y avisos</p>
        </div>
        <AuditorCampana />
      </header>
        ...
        {cargando ? (
          ...
          <>
            <section>
              ...
              {pendientes.length === 0 ? (
                <div
                  className="rounded-xl border border-dashed border-border p-6 flex flex-col items-center gap-2"
                >
