...
function RedirCalendario() {
  return <Navigate to="/auditor/agenda?tab=calendario" replace />
}
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: "auditor/calendario", Component: RedirCalendario },
              ...
              { path: "auditor/auditoria/:auditoriaId/azzule", Component: AuditorModoAzzule },
